...
const myFirstArray = ['Элина', 8888 , 9999, true , false];// объявите переменную здесь
console.log(myFirstArray);

//Задание 2
//Создайте массив mySecondArray, заполните его любыми значениями. Выведите длину массива.
const mySecondArray = ["В", "первый", "раз", "я", "запел", "про", "любовь"];// объявите переменную здесь
...
const myInformation = ['Элина', 8 , 'июня', 'близнецы'];
...
colors.forEach(function (nameOfColors){
     console.log(nameOfColors);
});
//Задание 9
...
let addedrussianCities = ['Санкт-Петербург' , 'Москва' , 'Екатеринбург'];
let russianCities = [...addedrussianCities , 'Казань', 'Нижний Новгород'];
